                ...
                <div class="w-full  2xl:px-16 xl:px-16 lg:px-16 md:px-10 sm:px-10 4xl:px-6 5xl:px-6 xs:px-6  ">
                    <div class="flex-none lg:mt-0 md:mr-0 sm:mr-0 4xl:mr-0 5xl:mr-0 xs:ml-4  lg:hidden">
                        <label for="my-drawer-3"
                            class="btn text-black hover:bg-blue-500 hover:text-white btn-square btn-ghost">
                    ...
                    <div
                        ...
                        <ul class="menu menu-horizontal">
                            <li><nuxt-link class="text-black" to="/spinnerAbout">درباره ما</nuxt-link></li>
                            <div class="border border-black"></div>
                            <li><nuxt-link class="text-black" to="/spinnerContact">ارتباط با ما</nuxt-link></li>
                            <div class="border border-black"></div>
                            <li><nuxt-link class="text-black" to="/spinnerBlog">بلاگ</nuxt-link></li>
                            <div class="border border-black"></div>
                            <li><nuxt-link class="text-black" to="/spinnerDelivery">روش های تحویل</nuxt-link></li>
                            <div class="border border-black"></div>
                            <li><nuxt-link class="text-black" to="/spinnerFlowerHouses">گل خانه ها</nuxt-link></li>
                            <div class="border  border-black"></div>
